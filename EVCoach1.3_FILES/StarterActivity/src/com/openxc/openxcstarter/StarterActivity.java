...
public class StarterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		carOptions = (Spinner) findViewById(R.id.carOptions);
		//JSONObject obj = new JSONObject(loadJSONFromAssets());
		
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,R.array.car_options, android.R.layout.simple_spinner_item);
		// Specify the layout to use when the list of choices appears
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		// Apply the adapter to the spinner
		carOptions.setAdapter(adapter);
		//carOptions.setOnItemSelectedListener(this);

	}
	
	public void onItemSelected(AdapterView<?> parentView, View v, int position,
			long id) {
		if(carOptions.getSelectedItem().toString().equals("Combustion City")){
			
		}
		if(carOptions.getSelectedItem().toString().equals("Combustion Highway")){
			
		}
		if(carOptions.getSelectedItem().toString().equals("HEV City")){
			
		}
		if(carOptions.getSelectedItem().toString().equals("HEV Highway")){
			
		}
		if(carOptions.getSelectedItem().toString().equals("PHEV City")){
			
		}
		if(carOptions.getSelectedItem().toString().equals("PHEV Highway")){
			
		}
		if(carOptions.getSelectedItem().toString().equals("BEV City")){
			
		}
		if(carOptions.getSelectedItem().toString().equals("BEV Highway")){
